  ...
  return (
    <div className="space-y-4">
      ...
      <PhaseHeroCard
        ...
        desc={
          <>
            Fase de <strong>último recurso</strong>. Empareja positivos y negativos de{" "}
            <strong>monto exactamente igual</strong> sin ninguna restricción geográfica ni de n_diario.
            Se ejecuta <strong>después de F6/F7/F7b</strong> para no consumir contrapartes que esas fases necesitan.
          </>
        }
      >
        <div className="grid grid-cols-4 gap-4">
          <PhaseKpi value={f5.conciliados.toLocaleString()} label="Registros conciliados" color="#ef4444" />
          <PhaseKpi value={`${f5.pct_sobre_conciliados.toFixed(1)}%`} label="% sobre conciliados" />
          <PhaseKpi value={`${f5.pct_sobre_total.toFixed(1)}%`} label="% sobre total" />
